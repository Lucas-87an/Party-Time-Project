  ...
  return (
    <div className='form-page'>
        ...
        <form onSubmit={(e)=> createParty(e)}>
            ...
            <label>
                <span>Imagem:</span>
                <input type="text" placeholder='Insiria a URL de uma imagem' required onChange={(e)=> setImage(e.target.value)} value={image} />
            </label>
            <div>
            ...
            <input type="submit" value="Criar Festa" className='btn-submit' />
        </form>
    </div>
  )
}
